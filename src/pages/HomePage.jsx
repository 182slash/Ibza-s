...
.scroll-animation-line-class {
    ...
    margin-bottom: 20px;
        ...
        .hero-rule {
          height: 0.5px;
          background: linear-gradient(90deg, transparent 0%, rgba(201,168,76,0.55) 25%, rgba(201,168,76,0.55) 75%, transparent 100%);
        ...
        .lux-btn-solid::before {
          ...
          position: absolute;
          inset: 0;
          background: linear-gradient(105deg, transparent 20%, rgba(255,220,120,0.18) 40%, rgba(255,240,160,0.28) 50%, rgba(255,220,120,0.18) 60%, transparent 80%);
        ...
        .lux-btn-solid:hover {
          ...
          box-shadow: 0 8px 28px rgba(30,80,45,0.55), 0 0 20px rgba(180,140,50,0.20), inset 0 1px 0 rgba(255,220,120,0.18);
        }
